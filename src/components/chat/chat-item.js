    ...
    return (
        ...
        <li className='list-group-item'>
            <div className="d-flex w-100 justify-content-between">
                ...
                <div id="adminButtons" className="btn-group btn-group-lg invisible" role="group" aria-label="Large button group">
                ...
                {
                    currentUser._id === uid &&
                    document.getElementById("adminButtons").setAttribute('class', 'btn-group btn-group-lg')
                }
